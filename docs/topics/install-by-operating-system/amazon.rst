...
==============================
To install Salt on Amazon Linux 2:

#. Run the following commands to install the Salt Project repository and key:

   .. tab-set::

       .. tab-item:: Amazon Linux 2 (Tiamat)

           To pin your Salt upgrades to the latest :ref:`tiamat` package of Salt for **Amazon Linux 2**:

           .. parsed-literal::

               sudo rpm --import \ |amazon-linux2-tiamat-gpg|\

               curl -fsSL \ |amazon-linux2-tiamat-download|\  | sudo tee /etc/yum.repos.d/salt-amzn.repo
